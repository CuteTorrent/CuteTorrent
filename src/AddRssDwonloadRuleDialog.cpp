...
AddRssDwonloadRuleDialog::AddRssDwonloadRuleDialog(QWidget* parent, DiaologMode mode) : BaseWindow(OnlyCloseButton, NoResize, parent), m_currentRule(new RssDownloadRule())
{
	m_inited = false;
	setupUi(this);
	setupStatusBar();
