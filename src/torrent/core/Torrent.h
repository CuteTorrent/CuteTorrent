...
public :
	...
	int GetUploadSpeed();
	QString GetDwonloadSpeedStr();
	QString GetUploadSpeedStr();
	QString GetSavePath();
	...
	QString GetSeedString(bool shortMode = false);
	QString GetPeerString(bool shortMode = false);
	...
	QString GetDwonloadSpeedStr() const;
	QString GetUploadSpeedStr() const;
