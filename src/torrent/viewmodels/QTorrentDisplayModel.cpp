...
void QTorrentDisplayModel::setupContextMenu()
{
	...
	StyleEngene* pStyleEngene = StyleEngene::getInstance();
	pauseTorrent = new QAction(pStyleEngene->getIcon("pause"), tr("ACTION_TORRENTLIST_PAUSE"), m_pTorrentListView);
	pauseTorrent->setObjectName("ACTION_TORRENTLIST_PAUSE");
	connect(pauseTorrent, SIGNAL(triggered()), this, SLOT(PauseSelected()));
	resumeTorrent = new QAction(pStyleEngene->getIcon("play"), tr("ACTION_TORRENTLIST_RESUME"), m_pTorrentListView);
	...
	openDir = new QAction(pStyleEngene->getIcon("open_folder"), tr("ACTION_OPEN_FOLDER"), m_pTorrentListView);
	...
	menu->addSeparator();
	mountDiskImage = new QAction(pStyleEngene->getIcon("daemon_tools"), tr("ACTION_DT_MOUNT"), m_pTorrentListView);
	...
	storrageMove = new QAction(pStyleEngene->getIcon("move_folder"), tr("ACTION_MOVE_STORRAGE"), m_pTorrentListView);
	...
	queueUp = new QAction(pStyleEngene->getIcon("queue_up"), tr("ACTION_QUEUE_UP"), m_pTorrentListView);
	queueUp->setObjectName("ACTION_TORRENTQUEUE_UP");
	connect(queueUp, SIGNAL(triggered()), SLOT(MoveUpQueue()));
	queueMenu->addAction(queueUp);
	queueDown = new QAction(pStyleEngene->getIcon("queue_down"), tr("ACTION_QUEUE_DOWN"), m_pTorrentListView);
	...
	queueTop = new QAction(pStyleEngene->getIcon("queue_top"), tr("ACTION_QUEUE_TOP"), m_pTorrentListView);
	...
	queueBottom = new QAction(pStyleEngene->getIcon("queue_bottom"), tr("ACTION_QUEUE_BOTTOM"), m_pTorrentListView);
	...
	priorityMenu = new QMenu(tr("ACTION_PRIORITY"), m_pTorrentListView);
	priorityMenu->setIcon(pStyleEngene->getIcon("priority"));
	highPriority = new QAction(tr("ACTION_HIGHT_PRIORITY"), m_pTorrentListView);
	...
	abowAvgPriority = new QAction(tr("ACTION_ABOVE_AVG_PRIORITY"), m_pTorrentListView);
	...
	mediumPriority = new QAction(tr("ACTION_MEDIUM_PRIORITY"), m_pTorrentListView);
	...
	belowAvgPriority = new QAction(tr("ACTION_BELOW_AVG_PRIORITY"), m_pTorrentListView);
	...
	lowPriority = new QAction(tr("ACTION_LOW_PRIORITY"), m_pTorrentListView);
	...
	menu->addSeparator();
	superSeed = new QAction(pStyleEngene->getIcon("super_seed"), tr("ACTION_SET_SUPERSEED"), m_pTorrentListView);
	...
	HashRecheck = new QAction(pStyleEngene->getIcon("recheck"), tr("ACTION_REHASH"), m_pTorrentListView);
	...
	updateTrackers = new QAction(pStyleEngene->getIcon("update_trackers"), tr("ACTION_UPDATE_TRACKERS"), m_pTorrentListView);
	...
	setSequentual = new QAction(pStyleEngene->getIcon("sequential"), tr("ACTION_SET_SEQUENTIAL"), m_pTorrentListView);
	...
	generateMagnet = new QAction(pStyleEngene->getIcon("magnet"), tr("ACTION_GENERATE_MAGNET"), m_pTorrentListView);
	...
	menu->addSeparator();
	deleteWithFiles = new QAction(pStyleEngene->getIcon("delete"), tr("ACTION_DELETE_ALL"), m_pTorrentListView);
	...
	deleteTorrentOnly = new QAction(pStyleEngene->getIcon("delete"), tr("ACTION_DELETE_TORRENT"), m_pTorrentListView);
	...
	groupsMenu = new QMenu(tr("ACTION_CHANGE_GROUP"), m_pTorrentListView);
