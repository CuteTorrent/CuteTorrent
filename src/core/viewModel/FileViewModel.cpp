...
void FileViewModel::setupFileTabelContextMenu()
{
	...
	lowPriority->setObjectName("ACTION_FILEPRIORITY_LOW");
	...
	mediumPriority->setObjectName("ACTION_FILEPRIORITY_MEDIUM");
	...
	highPriority->setObjectName("ACTION_FILEPRIORITY_HIGH");
	...
	dontDownload->setObjectName("ACTION_FILEPRIORITY_ZERO");
