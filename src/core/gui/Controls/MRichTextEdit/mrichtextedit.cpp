...
void MRichTextEdit::setupIcons()
{
	...
	f_undo->setIcon(pStyleEngene->getIcon("edit-undo"));
	f_redo->setIcon(pStyleEngene->getIcon("edit-redo"));
	f_cut->setIcon(pStyleEngene->getIcon("edit-cut"));
	f_copy->setIcon(pStyleEngene->getIcon("edit-copy"));
	f_paste->setIcon(pStyleEngene->getIcon("edit-paste"));
	f_link->setIcon(pStyleEngene->getIcon("applications-internet"));
	f_bold->setIcon(pStyleEngene->getIcon("format-text-bold"));
	f_italic->setIcon(pStyleEngene->getIcon("format-text-italic"));
	f_strikeout->setIcon(pStyleEngene->getIcon("format-text-strike-out"));
	f_list_bullet->setIcon(pStyleEngene->getIcon("format-bulet-list"));
	f_list_ordered->setIcon(pStyleEngene->getIcon("format-order-list"));
	f_underline->setIcon(pStyleEngene->getIcon("format-text-underline"));
	f_indent_dec->setIcon(pStyleEngene->getIcon("format-indent-less"));
	f_indent_inc->setIcon(pStyleEngene->getIcon("format-indent-more"));
}
