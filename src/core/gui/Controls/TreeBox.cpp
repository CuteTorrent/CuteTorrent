...
// -------------------------------------------------------------------------
void TreeBox::setVisibleModelColumn(int index)
{
	Q_D(TreeBox);
...
// -------------------------------------------------------------------------
QModelIndex TreeBox::currentIndex() const
{
	return treeView()->currentIndex();
}

// -------------------------------------------------------------------------
void TreeBox::setCurrentIndex(const QModelIndex& idx)
{
	QModelIndex prevRootIndex = rootModelIndex();
	if (idx.parent().isValid())
	{
		setRootModelIndex(idx.parent());
	}
	setCurrentIndex(idx.row());
	setRootModelIndex(prevRootIndex);
}

void TreeBox::setCurrentIndex(const int& idx)
{
	Superclass::setCurrentIndex(idx);
}

// -------------------------------------------------------------------------
bool TreeBox::eventFilter(QObject* object, QEvent* _event)
{
	Q_D(TreeBox);
	Q_UNUSED(object);
	bool res = false;
...
void TreeBox::hidePopup()
{
	...
	else
	{
		...
		//qDebug() << "TreeBox::hidePopup() " << _currentIndex << " " << _currentIndex.row();
